<template>
  <q-layout view="hHh lpR fFf">
    <q-header class="text-dark optout-header" height-hint="98">
      <q-toolbar>
        <q-toolbar-title>
          ...
          Grupo Uni.co
        <q-avatar rounded @click="logout">
          <img v-bind:src="user.photoURL || userPhotoDefault">
        </q-avatar>
        </q-toolbar-title>
      </q-toolbar>
    </q-header>
    ...
    <q-page-container class="pageWhatsApp">
      ...
      <p align="center" class="textPageWhatsApp" v-if="errorResponse">
          <b>Houve um erro no envio da sua solicitação, <br />por favor tente novamente mais tarde!</b>
      </p>
      <p align="center" class="textPageWhatsApp" v-if="successResponse">
        <b>Sua solicitação está sendo processada com sucesso</b>
      </p>
      <p
        align="center"
...
export default {
  ...
  data() {
    return {
      ...
      userPhotoDefault: "./avatar_default.png"
    };
  },
  computed: {
    user: function() {
